...
class PlantDetails extends StatelessWidget {
  PlantDetails({super.key, required this.name, required this.imageURL, required this.description, required this.kingdom, required this.family, required this.commonName});
        ...
        child: SingleChildScrollView(child: Column(
          children: <Widget>[
            ...
            Text(
              'Plant Details',
              style:
                  GoogleFonts.lato(fontSize: 30.0, fontWeight: FontWeight.w800),
            ),
            const SizedBox(
              height: 20,
            ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        children: [
                          Text("Kingdom", style: GoogleFonts.lato(fontSize: 17, fontWeight: FontWeight.w700), ),
                          Text(kingdom),
                        ],
                      ),
                      Column(
                        children: [
                          Text("Family", style: GoogleFonts.lato(fontSize: 17, fontWeight: FontWeight.w700), ),
                          Text(family),
                        ],
                      ),
                      Column(
                        children: [
                          Text("Common Name", style: GoogleFonts.lato(fontSize: 17, fontWeight: FontWeight.w700), ),
                          Text(commonName),
                        ],
                      ),
                    ],
                  ...
                  Text("Featured Plants", style: GoogleFonts.lato(fontSize: 20, fontWeight: FontWeight.w700),),
