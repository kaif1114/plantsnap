...
class SavedPlantsState extends State<SavedPlants> {
  ...
  StreamController<List<Map<String, dynamic>>> savedPlantsStream = StreamController<List<Map<String, dynamic>>>();

  Future<void> getSavedPlants() async {
    final userId = FirebaseAuth.instance.currentUser?.uid;
    print("USER ID: $userId");
    List<Map<String, dynamic>> savedPlants = await firestoreService.getAllDocuments(userId!);
    print(savedPlants);
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Column(
              children: [
                ...
                Expanded( // Use Expanded to ensure ListView.builder gets bounded constraints
                      ...
                      return GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context){
                            return PlantDetails(name: savedPlant["plantName"], imageURL: savedPlant["imageURL"], description: savedPlant["plantDescription"], kingdom: savedPlant["plantKingdom"], family: savedPlant["plantFamily"], commonName: savedPlant["commonName"]);
                          }));
                        },
                        child: Card(
